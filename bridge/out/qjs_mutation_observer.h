...
*/
#ifndef BRIDGE_QJS_MUTATION_OBSERVER_H
#define BRIDGE_QJS_MUTATION_OBSERVER_H
...
class QJSMutationObserver : public QJSInterfaceBridge<QJSMutationObserver, MutationObserver> {
 public:
...
#endif // BRIDGE_QJS_MUTATION_OBSERVER_H