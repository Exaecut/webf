...
*/
#ifndef BRIDGE_QJS_NATIVE_LOADER_H
#define BRIDGE_QJS_NATIVE_LOADER_H
...
class QJSNativeLoader : public QJSInterfaceBridge<QJSNativeLoader, NativeLoader> {
 public:
...
#endif // BRIDGE_QJS_NATIVE_LOADER_H