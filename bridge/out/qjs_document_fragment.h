...
*/
#ifndef BRIDGE_QJS_DOCUMENT_FRAGMENT_H
#define BRIDGE_QJS_DOCUMENT_FRAGMENT_H
...
class QJSDocumentFragment : public QJSInterfaceBridge<QJSDocumentFragment, DocumentFragment> {
 public:
...
#endif // BRIDGE_QJS_DOCUMENT_FRAGMENT_H