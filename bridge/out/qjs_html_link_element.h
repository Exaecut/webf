...
*/
#ifndef BRIDGE_QJS_HTML_LINK_ELEMENT_H
#define BRIDGE_QJS_HTML_LINK_ELEMENT_H
...
class QJSHTMLLinkElement : public QJSInterfaceBridge<QJSHTMLLinkElement, HTMLLinkElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_LINK_ELEMENT_H