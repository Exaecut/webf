...
*/
#ifndef BRIDGE_QJS_FOCUS_EVENT_H
#define BRIDGE_QJS_FOCUS_EVENT_H
...
#endif
class QJSFocusEvent : public QJSInterfaceBridge<QJSFocusEvent, FocusEvent> {
 public:
...
#endif // BRIDGE_QJS_FOCUS_EVENT_H