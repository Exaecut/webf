...
namespace webf {
NativeValue PerformanceMarkPublicMethods::Detail(PerformanceMark* performance_mark, SharedExceptionState* shared_exception_state) {
  auto value = performance_mark->detail();
  auto native_value = value.ToNative(performance_mark->ctx(), shared_exception_state->exception_state, false);
  return native_value;
}
}  // namespace webf
