...
*/
#ifndef BRIDGE_QJS_ELEMENT_ATTRIBUTES_H
#define BRIDGE_QJS_ELEMENT_ATTRIBUTES_H
...
class QJSElementAttributes : public QJSInterfaceBridge<QJSElementAttributes, ElementAttributes> {
 public:
...
#endif // BRIDGE_QJS_ELEMENT_ATTRIBUTES_H