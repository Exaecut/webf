...
*/
#ifndef BRIDGE_QJS_SVG_TEXT_ELEMENT_H
#define BRIDGE_QJS_SVG_TEXT_ELEMENT_H
...
class QJSSVGTextElement : public QJSInterfaceBridge<QJSSVGTextElement, SVGTextElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_TEXT_ELEMENT_H