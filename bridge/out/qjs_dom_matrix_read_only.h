...
*/
#ifndef BRIDGE_QJS_DOM_MATRIX_READ_ONLY_H
#define BRIDGE_QJS_DOM_MATRIX_READ_ONLY_H
#include <quickjs/quickjs.h>
#include "bindings/qjs/wrapper_type_info.h"
#include "bindings/qjs/generated_code_helper.h"
#include "core/geometry/dom_matrix_read_only.h"
namespace webf {
class ExecutingContext;
class QJSDOMMatrixReadOnly : public QJSInterfaceBridge<QJSDOMMatrixReadOnly, DOMMatrixReadOnly> {
 public:
...
#endif // BRIDGE_QJS_DOM_MATRIX_READ_ONLY_H