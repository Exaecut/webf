...
*/
#ifndef BRIDGE_QJS_HTML_IMAGE_ELEMENT_H
#define BRIDGE_QJS_HTML_IMAGE_ELEMENT_H
...
class QJSHTMLImageElement : public QJSInterfaceBridge<QJSHTMLImageElement, HTMLImageElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_IMAGE_ELEMENT_H