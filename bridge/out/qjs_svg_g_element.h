...
*/
#ifndef BRIDGE_QJS_SVG_G_ELEMENT_H
#define BRIDGE_QJS_SVG_G_ELEMENT_H
...
class QJSSVGGElement : public QJSInterfaceBridge<QJSSVGGElement, SVGGElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_G_ELEMENT_H