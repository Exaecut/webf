...
*/
#ifndef BRIDGE_QJS_PROMISE_REJECTION_EVENT_H
#define BRIDGE_QJS_PROMISE_REJECTION_EVENT_H
...
// width.
#if ANDROID_32_BIT
struct NativePromiseRejectionEvent {
...
#endif
class QJSPromiseRejectionEvent : public QJSInterfaceBridge<QJSPromiseRejectionEvent, PromiseRejectionEvent> {
 public:
...
#endif // BRIDGE_QJS_PROMISE_REJECTION_EVENT_H