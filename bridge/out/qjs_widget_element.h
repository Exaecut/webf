...
*/
#ifndef BRIDGE_QJS_WIDGET_ELEMENT_H
#define BRIDGE_QJS_WIDGET_ELEMENT_H
...
class QJSWidgetElement : public QJSInterfaceBridge<QJSWidgetElement, WidgetElement> {
 public:
...
#endif // BRIDGE_QJS_WIDGET_ELEMENT_H