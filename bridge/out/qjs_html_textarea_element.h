...
*/
#ifndef BRIDGE_QJS_HTML_TEXTAREA_ELEMENT_H
#define BRIDGE_QJS_HTML_TEXTAREA_ELEMENT_H
...
class QJSHTMLTextareaElement : public QJSInterfaceBridge<QJSHTMLTextareaElement, HTMLTextareaElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_TEXTAREA_ELEMENT_H