...
*/
#ifndef BRIDGE_QJS_DOM_POINT_READ_ONLY_H
#define BRIDGE_QJS_DOM_POINT_READ_ONLY_H
#include <quickjs/quickjs.h>
#include "bindings/qjs/wrapper_type_info.h"
#include "bindings/qjs/generated_code_helper.h"
#include "core/geometry/dom_point_read_only.h"
namespace webf {
class ExecutingContext;
class QJSDOMPointReadOnly : public QJSInterfaceBridge<QJSDOMPointReadOnly, DOMPointReadOnly> {
 public:
...
#endif // BRIDGE_QJS_DOM_POINT_READ_ONLY_H