...
*/
#ifndef BRIDGE_QJS_INLINE_CSS_STYLE_DECLARATION_H
#define BRIDGE_QJS_INLINE_CSS_STYLE_DECLARATION_H
...
class QJSInlineCssStyleDeclaration : public QJSInterfaceBridge<QJSInlineCssStyleDeclaration, InlineCssStyleDeclaration> {
 public:
...
#endif // BRIDGE_QJS_INLINE_CSS_STYLE_DECLARATION_H