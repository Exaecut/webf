...
*/
#ifndef BRIDGE_QJS_DOM_MATRIX_H
#define BRIDGE_QJS_DOM_MATRIX_H
...
class QJSDOMMatrix : public QJSInterfaceBridge<QJSDOMMatrix, DOMMatrix> {
 public:
