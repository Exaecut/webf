...
*/
#ifndef BRIDGE_QJS_SVG_CIRCLE_ELEMENT_H
#define BRIDGE_QJS_SVG_CIRCLE_ELEMENT_H
...
class QJSSVGCircleElement : public QJSInterfaceBridge<QJSSVGCircleElement, SVGCircleElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_CIRCLE_ELEMENT_H