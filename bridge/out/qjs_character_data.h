...
*/
#ifndef BRIDGE_QJS_CHARACTER_DATA_H
#define BRIDGE_QJS_CHARACTER_DATA_H
...
class QJSCharacterData : public QJSInterfaceBridge<QJSCharacterData, CharacterData> {
 public:
...
#endif // BRIDGE_QJS_CHARACTER_DATA_H