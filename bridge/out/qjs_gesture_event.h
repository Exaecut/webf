...
*/
#ifndef BRIDGE_QJS_GESTURE_EVENT_H
#define BRIDGE_QJS_GESTURE_EVENT_H
...
struct NativeGestureEvent {
NativeEvent native_event;
SharedNativeString* state;
SharedNativeString* direction;
double deltaX;
double deltaY;
double velocityX;
double velocityY;
...
#endif
class QJSGestureEvent : public QJSInterfaceBridge<QJSGestureEvent, GestureEvent> {
 public:
...
#endif // BRIDGE_QJS_GESTURE_EVENT_H