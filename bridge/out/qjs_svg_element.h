...
*/
#ifndef BRIDGE_QJS_SVG_ELEMENT_H
#define BRIDGE_QJS_SVG_ELEMENT_H
...
class QJSSVGElement : public QJSInterfaceBridge<QJSSVGElement, SVGElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_ELEMENT_H