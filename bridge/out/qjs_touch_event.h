...
*/
#ifndef BRIDGE_QJS_TOUCH_EVENT_H
#define BRIDGE_QJS_TOUCH_EVENT_H
...
int64_t touches;
int64_t targetTouches;
int64_t changedTouches;
int64_t altKey;
int64_t metaKey;
int64_t ctrlKey;
int64_t shiftKey;
...
#endif
class QJSTouchEvent : public QJSInterfaceBridge<QJSTouchEvent, TouchEvent> {
 public:
...
#endif // BRIDGE_QJS_TOUCH_EVENT_H