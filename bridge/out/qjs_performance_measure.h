...
*/
#ifndef BRIDGE_QJS_PERFORMANCE_MEASURE_H
#define BRIDGE_QJS_PERFORMANCE_MEASURE_H
...
class QJSPerformanceMeasure : public QJSInterfaceBridge<QJSPerformanceMeasure, PerformanceMeasure> {
 public:
...
#endif // BRIDGE_QJS_PERFORMANCE_MEASURE_H