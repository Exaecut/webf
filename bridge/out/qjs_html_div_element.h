...
*/
#ifndef BRIDGE_QJS_HTML_DIV_ELEMENT_H
#define BRIDGE_QJS_HTML_DIV_ELEMENT_H
...
class QJSHTMLDivElement : public QJSInterfaceBridge<QJSHTMLDivElement, HTMLDivElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_DIV_ELEMENT_H