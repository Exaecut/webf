...
*/
#ifndef BRIDGE_QJS_HTML_BODY_ELEMENT_H
#define BRIDGE_QJS_HTML_BODY_ELEMENT_H
...
class QJSHTMLBodyElement : public QJSInterfaceBridge<QJSHTMLBodyElement, HTMLBodyElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_BODY_ELEMENT_H