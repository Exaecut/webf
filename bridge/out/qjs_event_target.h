...
*/
#ifndef BRIDGE_QJS_EVENT_TARGET_H
#define BRIDGE_QJS_EVENT_TARGET_H
...
class QJSEventTarget : public QJSInterfaceBridge<QJSEventTarget, EventTarget> {
 public:
...
#endif // BRIDGE_QJS_EVENT_TARGET_H