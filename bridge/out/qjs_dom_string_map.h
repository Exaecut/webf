...
*/
#ifndef BRIDGE_QJS_DOM_STRING_MAP_H
#define BRIDGE_QJS_DOM_STRING_MAP_H
...
class QJSDOMStringMap : public QJSInterfaceBridge<QJSDOMStringMap, DOMStringMap> {
 public:
...
#endif // BRIDGE_QJS_DOM_STRING_MAP_H