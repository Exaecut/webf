...
*/
#ifndef BRIDGE_QJS_MESSAGE_EVENT_H
#define BRIDGE_QJS_MESSAGE_EVENT_H
...
NativeEvent native_event;
void* data;
SharedNativeString* origin;
SharedNativeString* lastEventId;
SharedNativeString* source;
};
#endif
class QJSMessageEvent : public QJSInterfaceBridge<QJSMessageEvent, MessageEvent> {
 public:
...
#endif // BRIDGE_QJS_MESSAGE_EVENT_H