...
*/
#ifndef BRIDGE_QJS_HTML_ELEMENT_H
#define BRIDGE_QJS_HTML_ELEMENT_H
...
class QJSHTMLElement : public QJSInterfaceBridge<QJSHTMLElement, HTMLElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_ELEMENT_H