...
*/
#ifndef BRIDGE_QJS_MUTATION_RECORD_H
#define BRIDGE_QJS_MUTATION_RECORD_H
...
class QJSMutationRecord : public QJSInterfaceBridge<QJSMutationRecord, MutationRecord> {
 public:
...
#endif // BRIDGE_QJS_MUTATION_RECORD_H