...
*/
#ifndef BRIDGE_QJS_SVG_TEXT_CONTENT_ELEMENT_H
#define BRIDGE_QJS_SVG_TEXT_CONTENT_ELEMENT_H
...
class QJSSVGTextContentElement : public QJSInterfaceBridge<QJSSVGTextContentElement, SVGTextContentElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_TEXT_CONTENT_ELEMENT_H