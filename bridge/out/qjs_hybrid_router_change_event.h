...
*/
#ifndef BRIDGE_QJS_HYBRID_ROUTER_CHANGE_EVENT_H
#define BRIDGE_QJS_HYBRID_ROUTER_CHANGE_EVENT_H
...
NativeEvent native_event;
void* state;
SharedNativeString* kind;
SharedNativeString* name;
};
#endif
class QJSHybridRouterChangeEvent : public QJSInterfaceBridge<QJSHybridRouterChangeEvent, HybridRouterChangeEvent> {
 public:
...
#endif // BRIDGE_QJS_HYBRID_ROUTER_CHANGE_EVENT_H