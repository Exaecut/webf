...
*/
#ifndef BRIDGE_QJS_MUTATION_OBSERVER_REGISTRATION_H
#define BRIDGE_QJS_MUTATION_OBSERVER_REGISTRATION_H
...
class QJSMutationObserverRegistration : public QJSInterfaceBridge<QJSMutationObserverRegistration, MutationObserverRegistration> {
 public:
...
#endif // BRIDGE_QJS_MUTATION_OBSERVER_REGISTRATION_H