...
*/
#ifndef BRIDGE_QJS_SVG_SVG_ELEMENT_H
#define BRIDGE_QJS_SVG_SVG_ELEMENT_H
...
class QJSSVGSVGElement : public QJSInterfaceBridge<QJSSVGSVGElement, SVGSVGElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_SVG_ELEMENT_H