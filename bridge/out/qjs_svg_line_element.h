...
*/
#ifndef BRIDGE_QJS_SVG_LINE_ELEMENT_H
#define BRIDGE_QJS_SVG_LINE_ELEMENT_H
...
class QJSSVGLineElement : public QJSInterfaceBridge<QJSSVGLineElement, SVGLineElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_LINE_ELEMENT_H