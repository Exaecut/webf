...
*/
#ifndef BRIDGE_QJS_HTML_HEAD_ELEMENT_H
#define BRIDGE_QJS_HTML_HEAD_ELEMENT_H
...
class QJSHTMLHeadElement : public QJSInterfaceBridge<QJSHTMLHeadElement, HTMLHeadElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_HEAD_ELEMENT_H