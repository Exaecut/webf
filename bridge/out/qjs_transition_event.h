...
*/
#ifndef BRIDGE_QJS_TRANSITION_EVENT_H
#define BRIDGE_QJS_TRANSITION_EVENT_H
...
NativeEvent native_event;
double elapsedTime;
SharedNativeString* propertyName;
SharedNativeString* pseudoElement;
};
#endif
class QJSTransitionEvent : public QJSInterfaceBridge<QJSTransitionEvent, TransitionEvent> {
 public:
...
#endif // BRIDGE_QJS_TRANSITION_EVENT_H