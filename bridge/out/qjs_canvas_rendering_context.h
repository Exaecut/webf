...
*/
#ifndef BRIDGE_QJS_CANVAS_RENDERING_CONTEXT_H
#define BRIDGE_QJS_CANVAS_RENDERING_CONTEXT_H
#include <quickjs/quickjs.h>
#include "bindings/qjs/wrapper_type_info.h"
#include "bindings/qjs/generated_code_helper.h"
#include "core/html/canvas/canvas_rendering_context.h"
namespace webf {
class ExecutingContext;
class QJSCanvasRenderingContext : public QJSInterfaceBridge<QJSCanvasRenderingContext, CanvasRenderingContext> {
 public:
...
#endif // BRIDGE_QJS_CANVAS_RENDERING_CONTEXT_H