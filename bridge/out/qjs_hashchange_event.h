...
*/
#ifndef BRIDGE_QJS_HASHCHANGE_EVENT_H
#define BRIDGE_QJS_HASHCHANGE_EVENT_H
...
struct NativeHashchangeEvent {
NativeEvent native_event;
SharedNativeString* newURL;
SharedNativeString* oldURL;
};
#endif
class QJSHashchangeEvent : public QJSInterfaceBridge<QJSHashchangeEvent, HashchangeEvent> {
 public:
...
#endif // BRIDGE_QJS_HASHCHANGE_EVENT_H