...
*/
#ifndef BRIDGE_QJS_SVG_ELLIPSE_ELEMENT_H
#define BRIDGE_QJS_SVG_ELLIPSE_ELEMENT_H
...
class QJSSVGEllipseElement : public QJSInterfaceBridge<QJSSVGEllipseElement, SVGEllipseElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_ELLIPSE_ELEMENT_H