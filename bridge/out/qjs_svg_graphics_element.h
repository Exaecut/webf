...
*/
#ifndef BRIDGE_QJS_SVG_GRAPHICS_ELEMENT_H
#define BRIDGE_QJS_SVG_GRAPHICS_ELEMENT_H
...
class QJSSVGGraphicsElement : public QJSInterfaceBridge<QJSSVGGraphicsElement, SVGGraphicsElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_GRAPHICS_ELEMENT_H