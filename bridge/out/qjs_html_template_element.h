...
*/
#ifndef BRIDGE_QJS_HTML_TEMPLATE_ELEMENT_H
#define BRIDGE_QJS_HTML_TEMPLATE_ELEMENT_H
...
class QJSHTMLTemplateElement : public QJSInterfaceBridge<QJSHTMLTemplateElement, HTMLTemplateElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_TEMPLATE_ELEMENT_H