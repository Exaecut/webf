...
*/
#ifndef BRIDGE_QJS_BOUNDING_CLIENT_RECT_H
#define BRIDGE_QJS_BOUNDING_CLIENT_RECT_H
...
class QJSBoundingClientRect : public QJSInterfaceBridge<QJSBoundingClientRect, BoundingClientRect> {
 public:
...
#endif // BRIDGE_QJS_BOUNDING_CLIENT_RECT_H