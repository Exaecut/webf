...
*/
#ifndef BRIDGE_QJS_SVG_RECT_ELEMENT_H
#define BRIDGE_QJS_SVG_RECT_ELEMENT_H
...
class QJSSVGRectElement : public QJSInterfaceBridge<QJSSVGRectElement, SVGRectElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_RECT_ELEMENT_H