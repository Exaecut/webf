...
*/
#ifndef BRIDGE_QJS_POINTER_EVENT_H
#define BRIDGE_QJS_POINTER_EVENT_H
...
int64_t isPrimary;
double pointerId;
SharedNativeString* pointerType;
double pressure;
double tangentialPressure;
double tiltX;
double tiltY;
...
#endif
class QJSPointerEvent : public QJSInterfaceBridge<QJSPointerEvent, PointerEvent> {
 public:
...
#endif // BRIDGE_QJS_POINTER_EVENT_H