...
*/
#ifndef BRIDGE_QJS_HTML_IFRAME_ELEMENT_H
#define BRIDGE_QJS_HTML_IFRAME_ELEMENT_H
...
class QJSHTMLIFrameElement : public QJSInterfaceBridge<QJSHTMLIFrameElement, HTMLIFrameElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_IFRAME_ELEMENT_H