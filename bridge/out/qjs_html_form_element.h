...
*/
#ifndef BRIDGE_QJS_HTML_FORM_ELEMENT_H
#define BRIDGE_QJS_HTML_FORM_ELEMENT_H
...
class QJSHTMLFormElement : public QJSInterfaceBridge<QJSHTMLFormElement, HTMLFormElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_FORM_ELEMENT_H