...
*/
#ifndef BRIDGE_QJS_HTML_COLLECTION_H
#define BRIDGE_QJS_HTML_COLLECTION_H
...
class QJSHTMLCollection : public QJSInterfaceBridge<QJSHTMLCollection, HTMLCollection> {
 public:
...
#endif // BRIDGE_QJS_HTML_COLLECTION_H