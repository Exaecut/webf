...
*/
#ifndef BRIDGE_QJS_POP_STATE_EVENT_H
#define BRIDGE_QJS_POP_STATE_EVENT_H
...
#endif
class QJSPopStateEvent : public QJSInterfaceBridge<QJSPopStateEvent, PopStateEvent> {
 public:
...
#endif // BRIDGE_QJS_POP_STATE_EVENT_H