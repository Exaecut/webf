...
*/
#ifndef BRIDGE_QJS_HTML_UNKNOWN_ELEMENT_H
#define BRIDGE_QJS_HTML_UNKNOWN_ELEMENT_H
...
class QJSHTMLUnknownElement : public QJSInterfaceBridge<QJSHTMLUnknownElement, HTMLUnknownElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_UNKNOWN_ELEMENT_H