...
*/
#ifndef BRIDGE_QJS_PERFORMANCE_ENTRY_H
#define BRIDGE_QJS_PERFORMANCE_ENTRY_H
...
class QJSPerformanceEntry : public QJSInterfaceBridge<QJSPerformanceEntry, PerformanceEntry> {
 public:
...
#endif // BRIDGE_QJS_PERFORMANCE_ENTRY_H