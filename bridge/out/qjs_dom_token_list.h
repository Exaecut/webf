...
*/
#ifndef BRIDGE_QJS_DOM_TOKEN_LIST_H
#define BRIDGE_QJS_DOM_TOKEN_LIST_H
...
class QJSDOMTokenList : public QJSInterfaceBridge<QJSDOMTokenList, DOMTokenList> {
 public:
...
#endif // BRIDGE_QJS_DOM_TOKEN_LIST_H