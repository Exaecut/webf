...
*/
#ifndef BRIDGE_QJS_HTML_CANVAS_ELEMENT_H
#define BRIDGE_QJS_HTML_CANVAS_ELEMENT_H
...
class QJSHTMLCanvasElement : public QJSInterfaceBridge<QJSHTMLCanvasElement, HTMLCanvasElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_CANVAS_ELEMENT_H