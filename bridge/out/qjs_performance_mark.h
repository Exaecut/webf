...
*/
#ifndef BRIDGE_QJS_PERFORMANCE_MARK_H
#define BRIDGE_QJS_PERFORMANCE_MARK_H
...
class QJSPerformanceMark : public QJSInterfaceBridge<QJSPerformanceMark, PerformanceMark> {
 public:
...
#endif // BRIDGE_QJS_PERFORMANCE_MARK_H