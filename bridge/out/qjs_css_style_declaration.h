...
*/
#ifndef BRIDGE_QJS_CSS_STYLE_DECLARATION_H
#define BRIDGE_QJS_CSS_STYLE_DECLARATION_H
...
class QJSCSSStyleDeclaration : public QJSInterfaceBridge<QJSCSSStyleDeclaration, CSSStyleDeclaration> {
 public:
...
#endif // BRIDGE_QJS_CSS_STYLE_DECLARATION_H