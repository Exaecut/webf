...
*/
#ifndef BRIDGE_QJS_HTML_BUTTON_ELEMENT_H
#define BRIDGE_QJS_HTML_BUTTON_ELEMENT_H
...
class QJSHTMLButtonElement : public QJSInterfaceBridge<QJSHTMLButtonElement, HTMLButtonElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_BUTTON_ELEMENT_H