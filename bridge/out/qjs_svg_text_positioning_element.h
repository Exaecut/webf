...
*/
#ifndef BRIDGE_QJS_SVG_TEXT_POSITIONING_ELEMENT_H
#define BRIDGE_QJS_SVG_TEXT_POSITIONING_ELEMENT_H
...
class QJSSVGTextPositioningElement : public QJSInterfaceBridge<QJSSVGTextPositioningElement, SVGTextPositioningElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_TEXT_POSITIONING_ELEMENT_H