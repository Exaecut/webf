...
*/
#ifndef BRIDGE_QJS_SVG_GEOMETRY_ELEMENT_H
#define BRIDGE_QJS_SVG_GEOMETRY_ELEMENT_H
...
class QJSSVGGeometryElement : public QJSInterfaceBridge<QJSSVGGeometryElement, SVGGeometryElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_GEOMETRY_ELEMENT_H