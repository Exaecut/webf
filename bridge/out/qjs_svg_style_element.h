...
*/
#ifndef BRIDGE_QJS_SVG_STYLE_ELEMENT_H
#define BRIDGE_QJS_SVG_STYLE_ELEMENT_H
...
class QJSSVGStyleElement : public QJSInterfaceBridge<QJSSVGStyleElement, SVGStyleElement> {
 public:
...
#endif // BRIDGE_QJS_SVG_STYLE_ELEMENT_H