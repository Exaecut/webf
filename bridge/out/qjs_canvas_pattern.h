...
*/
#ifndef BRIDGE_QJS_CANVAS_PATTERN_H
#define BRIDGE_QJS_CANVAS_PATTERN_H
...
class QJSCanvasPattern : public QJSInterfaceBridge<QJSCanvasPattern, CanvasPattern> {
 public:
...
#endif // BRIDGE_QJS_CANVAS_PATTERN_H