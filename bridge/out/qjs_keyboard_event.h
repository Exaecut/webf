...
*/
#ifndef BRIDGE_QJS_KEYBOARD_EVENT_H
#define BRIDGE_QJS_KEYBOARD_EVENT_H
...
#endif
class QJSKeyboardEvent : public QJSInterfaceBridge<QJSKeyboardEvent, KeyboardEvent> {
 public:
...
#endif // BRIDGE_QJS_KEYBOARD_EVENT_H