...
*/
#ifndef BRIDGE_QJS_HTML_INPUT_ELEMENT_H
#define BRIDGE_QJS_HTML_INPUT_ELEMENT_H
...
class QJSHTMLInputElement : public QJSInterfaceBridge<QJSHTMLInputElement, HTMLInputElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_INPUT_ELEMENT_H