...
*/
#ifndef BRIDGE_QJS_HTML_SCRIPT_ELEMENT_H
#define BRIDGE_QJS_HTML_SCRIPT_ELEMENT_H
...
class QJSHTMLScriptElement : public QJSInterfaceBridge<QJSHTMLScriptElement, HTMLScriptElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_SCRIPT_ELEMENT_H