...
*/
#ifndef BRIDGE_QJS_HTML_ANCHOR_ELEMENT_H
#define BRIDGE_QJS_HTML_ANCHOR_ELEMENT_H
...
class QJSHTMLAnchorElement : public QJSInterfaceBridge<QJSHTMLAnchorElement, HTMLAnchorElement> {
 public:
...
#endif // BRIDGE_QJS_HTML_ANCHOR_ELEMENT_H