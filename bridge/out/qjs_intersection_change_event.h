...
*/
#ifndef BRIDGE_QJS_INTERSECTION_CHANGE_EVENT_H
#define BRIDGE_QJS_INTERSECTION_CHANGE_EVENT_H
...
#endif
class QJSIntersectionChangeEvent : public QJSInterfaceBridge<QJSIntersectionChangeEvent, IntersectionChangeEvent> {
 public:
...
#endif // BRIDGE_QJS_INTERSECTION_CHANGE_EVENT_H