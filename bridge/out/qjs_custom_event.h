...
*/
#ifndef BRIDGE_QJS_CUSTOM_EVENT_H
#define BRIDGE_QJS_CUSTOM_EVENT_H
...
class QJSCustomEvent : public QJSInterfaceBridge<QJSCustomEvent, CustomEvent> {
 public:
...
#endif // BRIDGE_QJS_CUSTOM_EVENT_H